...
// End wla button pa functionality change ha wo ak baar check kr lana.
    ...
    <div className='w-full h-screen duration-200 ' style={{backgroundColor: Color}}>
      ...
      <div className='fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2'>
          <div className='flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-3xl'>
                ...
                <button className='outline-none px-4 py-1 rounded-full  text-white shadow-lg' style={{backgroundColor:"olive"}} onClick={()=> setColor('blue')}>Olive</button>
                ...
                <button className='outline-none px-4 py-1 rounded-full  text-black shadow-lg' style={{backgroundColor:"orange"}} onClick={ChangerColor}>orange</button>           
