...
function card({username,btnText="ALi"}) {   {/* inside card ({handling kehta ha}) aur yeh hmna destructing ki ha */}
  ...
  <div className="absolute bottom-4 left-4 text-left">
    ...
    <button className="mt-2 inline-flex cursor-pointer items-center text-sm font-semibold text-white">
      {btnText || "agr hmna value pass ni ki tu || lga kr jo pass krni ha wo likh do.React bolta"} →
    </button>
  </div>
</div>
  )
